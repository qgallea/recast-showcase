...
::: {.summary-lead}
Do higher corporate taxes dampen business investment? The original finds they do, and RECAST reproduces it; the effect stays negative under flexible machine learning, though it shifts modestly depending on which control variables are included.

[**RECAST verdict** — replication **PASS** (SUCCESS); passed two-referee AI review.]{.verdict}
:::

::: {.glance}
<div class="g"><span class="k">Field</span><span class="v">Public economics</span></div>
