...
**Citation:** Loyalka, P., Popova, A., Li, G., Shi, Z. (2019). *Does Teacher Training Actually Work? Evidence from a Large-Scale Randomized Evaluation of a National Teacher Training Program*. *American Economic Journal: Applied Economics*.

The null average effect, the CLAN sorting (9/10), and the GATES shape reproduce — but the BLP heterogeneity slope diverges from the benchmark (0.20 vs 0.65). Reported as implementation sensitivity, not a win.

::: {.glance}
<div class="g"><span class="k">Method path</span><span class="v">IRM + generic ML</span></div>
...
The displayed BLP learner is the neural-network proxy (the Λ-criterion best, matching the benchmark).
